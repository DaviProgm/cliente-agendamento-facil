        ...
        <div className="bg-secondary/20 p-6 rounded-2xl shadow-lg backdrop-blur">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-foreground/80">Cabeleireiro</p>
            </div>
          </div>
        </div>
        <div className="bg-secondary/20 p-6 rounded-2xl shadow-lg backdrop-blur">
          ...
          <div className="flex items-center">
            <img src="/placeholder.svg" alt="Avatar" className="w-12 h-12 rounded-full mr-4" />
            <div>
              <p className="font-semibold text-foreground">Maria Oliveira</p>
              <p className="text-sm text-foreground/80">Manicure</p>
            </div>
          </div>
        </div>
      </div>
